...
public class ChannelManager implements ConnectionEventListener {
    ...
    public Channel getChannel(String channelName) {
        if (channelName.startsWith("private-")) {
            throw new IllegalArgumentException(
                    "Please use the getPrivateChannel method"
            );
        } else if (channelName.startsWith("presence-")) {
            throw new IllegalArgumentException(
                    "Please use the getPresenceChannel method"
            );
        }
    ...
    public PrivateChannel getPrivateChannel(String channelName)
        ...
        if (!channelName.startsWith("private-")) {
            throw new IllegalArgumentException(
                    "Private channels must begin with 'private-'"
            );
        } else {
    ...
    public PresenceChannel getPresenceChannel(String channelName)
        ...
        if (!channelName.startsWith("presence-")) {
            throw new IllegalArgumentException(
                    "Presence channels must begin with 'presence-'"
            );
        } else {
    ...
    public void unsubscribeFrom(final String channelName) {
        if (channelName == null) {
            throw new IllegalArgumentException(
                    "Cannot unsubscribe from null channel"
            );
        }
    ...
    public void handleEvent(final PusherEvent event) {
        final InternalChannel channel = channelNameToChannelMap.get(
    ...
    private void validateArgumentsAndBindEvents(
        ...
        if (channelNameToChannelMap.containsKey(channel.getName())) {
            throw new IllegalArgumentException(
                    "Already subscribed to a channel with name " + channel.getName()
            );
        }
